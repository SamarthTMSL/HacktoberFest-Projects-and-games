...
white = (255, 255, 255)
# blue = (0, 0, 255)
game_over_text_color = (148, 160, 222)

screen_width = tile_size * 20
screen_height = tile_size * 20

screen = pygame.display.set_mode((screen_width, screen_height))
pygame.display.set_caption('Platformer_MS')
...
exit_img = pygame.transform.scale(
    exit_img, (start_img.get_width(), start_img.get_height()))

# load sounds
pygame.mixer.music.load('img/MEG.mp3')
pygame.mixer.music.play(-1, 0.0, 5000)
coin_fx = pygame.mixer.Sound('img/coin.wav')
coin_fx.set_volume(0.3)
jump_fx = pygame.mixer.Sound('img/JumpSound.mp3')
...
def reset_level(level):
    pygame.mixer.music.play(-1, 0.0, 5000)
    player.reset(tile_size*2, screen_height - 130)
    blob_group.empty()
    ...
    def update(self, game_over):
        ...
        if game_over == 0:
            ...
            if key[pygame.K_SPACE] == False:
                # stop the jump if key not pressed
                self.jumped = False
            if key[pygame.K_a]:
                dx -= 5
                self.counter += 1
            ...
            draw_text('GAME OVER!', font, game_over_text_color,
...
player = Player(tile_size*2, screen_height - 130)
...
while run:
    ...
    bg_img = pygame.transform.scale(
        bg_img, (screen_height, screen_width))

    rect = bg_img.get_rect().move(0, 0)
    ...
    if main_menu == True:
        ...
        if game_over == 1:
            ...
            if level <= max_levels:
                ...
                draw_text('YOU WIN!', font, game_over_text_color,
